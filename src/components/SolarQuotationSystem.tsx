...
export function SolarQuotationSystem() {
  ...
  const shareWhatsApp = () => {
    ...
    const text =` Hi, I generated a preliminary solar quote with Solar Captures for ${formData.customerName}. System: ${estimate.cap} kW ${estimate.system}. Est. Price: ${currency(estimate.net)}. Contact: ${formData.customerMobile || '—'}`;
